function dpca_plot_stat_all_stim(data, time, yspan, explVar, compNum, events, signif, marg)
...
if strcmp(data, 'legend')
    ...
    elseif length(time) == 4 && time(3) == 2
        ...
        text(1.2, -2, 'No-Go Condition')
        text(1.2, -3, 'Go Condition')
