function dpca_plot_errors(data, time, yspan, explVar, compNum, events, signif, marg)
...
% displaying legend
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Stimulus={['BioMov'] ['ObjMov'] ['MonkeyIII'] ['MonkeyI'] ['HumanGrasp'] ['HumanMimick'] };
if strcmp(data, 'legend')
    ...
    elseif length(time) == 3
        ...
        colors = [23 100 171; 187 20 25; 150 150 150; 114 97 171;137 90 95; 50 80 100; 124 187 71]/256;

        hold on
        
        for f = 1:numOfStimuli
            plot([0.5 1], [f f], 'color', colors(f,:), 'LineWidth', 2)
            text(1.2, f, Stimulus{f})
        end
    ...
    elseif length(time) == 4 && time(3) == 2
        ...
        text(1.2, -2, 'Condition1')
        text(1.2, -3, 'Condition2')
