function [h,z] = manovacluster_leaf_order(stats,method)
...
leafOrder = optimalleaforder(linkage(d(a<b)',method),d(a<b)');
z=linkage(d(a<b)', method);

hh = dendrogram(linkage(d(a<b)', method),'reorder',leafOrder,'ColorThreshold','default');
